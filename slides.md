...
USDC (USD Coin) là stablecoin loại fiat-backed được thiết kế để duy trì giá trị 1:1 với đô la Mỹ, được phát hành bởi Circle.

## Đặc điểm nổi bật

- **Được bảo chứng hoàn toàn**: Được hỗ trợ 100% bởi tiền mặt và các công cụ thị trường tiền tệ có tính thanh khoản cao
- **Khả năng quy đổi 1:1**: Mỗi USDC có thể đổi lại chính xác 1 USD
...
- **Tiền mặt**: USD thực
- **Công cụ thị trường tiền tệ**: Chủ yếu là trái phiếu chính phủ Mỹ ngắn hạn (Kho bạc Hoa Kỳ)
- **Các công cụ thanh khoản cao**: Thỏa thuận mua lại qua đêm với các ngân hàng hàng đầu thế giới
